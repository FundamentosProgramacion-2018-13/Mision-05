# encoding: UTF-8
# Autor: Roberto Martínez Román & Jonathan Sanabria Rocha
...
# Dibuja cuadrados sin que se toquen
#def cuadro(ventana):
    #origen = [CentroX,CentroY]    # lo manda exactamente en el origen 0,0.
    #inicio = [CentroX+10, CentroY]
    #pygame.draw.line(ventana, NEGRO, origen,inicio,1)
...
#Funcion que guarda las respuestas con respecto a la decision del usuario
def eleccionUsuario (eleccion):
    if eleccion == 1:
        dibujar(eleccion)
    elif eleccion == 2:
        dibujar(eleccion)
