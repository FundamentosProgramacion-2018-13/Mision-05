...
# Mediante ciclos for se realizaran diversas funciones muestrando en una pantalla seleccionable una figura o un valor numerico.
...
def dibujarCuadricula(ventana):
    Valor = 10
    #Lineas horizontales
    for y in range(0, 410, Valor):
        Parte = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        pygame.draw.line(ventana, Parte, (y, ALTO//2), (ANCHO//2, ALTO//2-y))
        pygame.draw.line(ventana, Parte, (ANCHO-y, ALTO//2), (ANCHO//2, ALTO//2-y))
        pygame.draw.line(ventana, Parte, (y, ALTO//2), (ANCHO//2, ALTO//2+y))
        pygame.draw.line(ventana, Parte, (ANCHO-y, ALTO//2), (ANCHO//2, ALTO//2+y))
...
def main():
    ...
    while opcion!=0:
        if opcion==1:
            ...
            terminos= int(input("Teclea cuántos terminos quieres: "))
