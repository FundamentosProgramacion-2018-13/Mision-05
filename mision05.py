...
#Compara el número de opción que eligió el ususario para hacer la función correspondiente.
def seleccionarAccion(seleccion):
    if seleccion == 1:
        dibujar(seleccion)
